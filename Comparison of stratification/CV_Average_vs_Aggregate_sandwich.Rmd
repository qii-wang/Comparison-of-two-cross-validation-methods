...
# Number of iteration
n_iter = 2000
source("funcs_calibrationMetrics sandwich.R")
library(caret)
library(pROC)
library(tidyverse)
library(doParallel)
...
out_AUC %>% write.csv("./Full stratification sandwich/AUC.csv", row.names = FALSE)
out_EOR %>% write.csv("./Full stratification sandwich/EOR.csv", row.names = FALSE)
out_cali_intc %>% write.csv("./Full stratification sandwich/Cali_intercept.csv", row.names = FALSE)
out_cali_slp %>% write.csv("./Full stratification sandwich/Cali_slope.csv", row.names = FALSE)
```
